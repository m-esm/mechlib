...
ALIASES = {
    ...
    'cam_lift': 'cam_profile_2d',
    'chebyshev_pose': 'chebyshev_linkage',
    'compliant_clutch': 'compliant_clutch_2d',
    'cv_velocity_fluctuation': 'hooke_pose',
    'cv_velocity_ratio': 'hooke_pose',
    'cycloidal_pose': 'cycloidal_drive',
    'dbore_hub': 'dbore',
    'escapement_pose': 'escapement',
    'fix_pin': 'screw_post',
    'four_bar_pose': 'four_bar',
    'geneva_wheel_angle': 'geneva_pair',
    'iris_control_range': 'iris_diaphragm',
    'lazy_tongs_pose': 'lazy_tongs',
    ...
    'quick_return_ratio': 'quick_return',
