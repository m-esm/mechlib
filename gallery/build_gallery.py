...
from mechlib.meshutil import extrude_poly_z, extrude_snapped
...
def build():
    ...
    models = [
        ...
        {
            "file": "bolt_mesh_demo.glb",
            "name": "bolt_mesh",
            "module": "mechlib.fasteners",
            "signature": signature(bolt_mesh),
            "description": "A head-down vertical bolt stand-in: cylindrical head and shank for fit-check layouts.",
            "origin": "Extracted from parviz src/standins/_common.py.",
            "demo": "demo_bolt_mesh",
        },
        {
            "file": "hex_nut_mesh_demo.glb",
            "name": "hex_nut_mesh",
            "module": "mechlib.fasteners",
            "signature": signature(hex_nut_mesh),
            "description": "A hex-nut stand-in from across-flats, height, and bore diameter.",
            "origin": "Extracted from parviz src/standins/_common.py.",
            "demo": "demo_hex_nut_mesh",
        },
        {
            "file": "washer_mesh_demo.glb",
            "name": "washer_mesh",
            "module": "mechlib.fasteners",
            "signature": signature(washer_mesh),
            "description": "A flat annular washer stand-in for stack-height and outer-diameter checks.",
            "origin": "Extracted from parviz src/standins/_common.py.",
            "demo": "demo_washer_mesh",
        },
        {
            "file": "cam_profile_2d_demo.glb",
            "name": "cam_profile_2d",
            "module": "mechlib.cams",
            "signature": signature(cam_profile_2d),
            "description": "A radial plate-cam pitch curve synthesized from SHM, dwell, and cycloidal segments, extruded thin for display.",
            "origin": "Cam motion-law synthesis in mechlib.cams.",
            "demo": "demo_cam_profile_2d",
        },
        {
            "file": "internal_gear_2d_demo.glb",
            "name": "internal_gear_2d",
            "module": "mechlib.gears",
            "signature": signature(internal_gear_2d),
            "description": "An annular involute ring-gear profile with inward teeth, extruded into a printable internal gear blank.",
            "origin": "Swept-envelope internal involute in mechlib.gears.",
            "demo": "demo_internal_gear_2d",
        },
        {
            "file": "trochoid_profile_2d_demo.glb",
            "name": "trochoid_profile_2d",
            "module": "mechlib.gears",
            "signature": signature(trochoid_profile_2d),
            "description": "A shortened-epitrochoid cycloidal disc profile, extruded as a thin disc coupon.",
            "origin": "Closed-form cycloidal disc in mechlib.gears.",
            "demo": "demo_trochoid_profile_2d",
        },
        {
            "file": "link_bar_demo.glb",
            "name": "link_bar",
            "module": "mechlib.linkages",
            "signature": signature(link_bar),
            "description": "A flat-printable capsule linkage bar with a pin bore at each centre-distance.",
            "origin": "Shared bar primitive behind mechlib.linkages.",
            "demo": "demo_link_bar",
        },
        {
            "file": "helix_solid_demo.glb",
            "name": "helix_solid",
            "module": "mechlib.mechanisms",
            "signature": signature(helix_solid),
            "description": "A closed radius-Z polygon swept along a capped watertight helix: a thread band or auger flight.",
            "origin": "Extracted from parviz src/threads.py.",
            "demo": "demo_helix_solid",
        },
        {
            "file": "gable_roof_demo.glb",
            "name": "gable_roof",
            "module": "mechlib.cutters",
            "signature": signature(gable_roof),
            "description": "A two-slope self-supporting roof over a wall opening so the slot prints without ceiling support.",
            "origin": "Extracted from finnish-doors src/projects/klonk/housings.py.",
            "demo": "demo_gable_roof",
        },
        {
            "file": "chamfer_cutter_demo.glb",
            "name": "chamfer_cutter",
            "module": "mechlib.cutters",
            "signature": signature(chamfer_cutter),
            "description": "A 45-degree end chamfer cut into a pin with the outside-ring cutter.",
            "origin": "Extracted from parviz src/standins/foot_pin.py.",
            "demo": "demo_chamfer_cutter",
        },
        {
            "file": "countersink_demo.glb",
            "name": "countersink",
            "module": "mechlib.cutters",
            "signature": signature(countersink),
            "description": "A 45-degree bore lead-in cut into a hex-nut stand-in down to the thread crest radius.",
            "origin": "Extracted from parviz src/standins/m8_nut.py.",
            "demo": "demo_countersink",
        },
        {
            "file": "slot_neg_demo.glb",
            "name": "slot_neg",
            "module": "mechlib.cutters",
            "signature": signature(slot_neg),
            "description": "An obround pedestal slot cut through a chassis plate, with extra travel at each end.",
            "origin": "Extracted from parviz src/chassis.py.",
            "demo": "demo_slot_neg",
        },
        {
            "file": "hex_corner_chamfer_demo.glb",
            "name": "hex_corner_chamfer",
            "module": "mechlib.cutters",
            "signature": signature(hex_corner_chamfer),
            "description": "45-degree corner chamfers on a hex nut that preserve the wrench flats.",
            "origin": "Extracted from parviz src/standins/m8_nut.py.",
            "demo": "demo_hex_corner_chamfer",
        },
        {
            "file": "extrude_down_demo.glb",
            "name": "extrude_down",
            "module": "mechlib.prim",
            "signature": signature(extrude_down),
            "description": "A hexagon extruded downward from a top plane into a short prism.",
            "origin": "Primitive extrusion helper in mechlib.prim.",
            "demo": "demo_extrude_down",
        },
        {
            "file": "extrude_poly_z_demo.glb",
            "name": "extrude_poly_z",
            "module": "mechlib.meshutil",
            "signature": signature(extrude_poly_z),
            "description": "A rectangle extruded between two world Z planes into a slab.",
            "origin": "Extracted from finnish-doors src/projects/klonk/housings.py.",
            "demo": "demo_extrude_poly_z",
        },
        {
            "file": "extrude_snapped_demo.glb",
            "name": "extrude_snapped",
            "module": "mechlib.meshutil",
            "signature": signature(extrude_snapped),
            "description": "Two near-neighbour polygons snapped to 1e-6 then extruded as separate volumes.",
            "origin": "Extracted from torque-lever build.py.",
            "demo": "demo_extrude_snapped",
        },
    ]
